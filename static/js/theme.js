...
const LS_KEY = 'acqua-os-theme';
const CUSTOM_THEMES_KEY = 'acqua-os-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Acqua OS Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'acqua-os_' + (obj.name || 'theme') + '.json';
      a.click();
